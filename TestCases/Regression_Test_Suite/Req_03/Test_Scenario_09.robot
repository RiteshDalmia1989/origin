...
TC_001
    ...
    Sleep    1s
    @{Roles}=    Get Webelements    xpath=//div[text()='Partner Team']//parent::div//parent::div//parent::div//parent::div//parent::div//parent::div//div[@id='react-collapsed-panel-814']//div//div//div//div//span
    FOR    ${Role}    IN    @{Roles}
    Log    ${Role}
    ${C}=    Get Text    ${Role}
    Log    ${C}
